import { ref, reactive, mergeProps, unref, computed, useSSRContext } from 'vue';
...
const ICONS = {
  ...
  sunny: "/img/sun.svg",
  // Иконка луны (ясно + ночной режим)
  moon: "/img/shadow.png",
  // Иконка облачно с солнцем
  cloudy: "/img/sunny2.png",
  // Иконка дождя
  rainy: "/img/wind2.png",
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "weather-card" }, _attrs))} data-v-65004a13><div class="weather-card__top" data-v-65004a13><div data-v-65004a13><p class="weather-card__temp" data-v-65004a13>${ssrInterpolate(__props.temp)}\xB0</p><p class="weather-card__day" data-v-65004a13>${ssrInterpolate(__props.dayLabel)}</p></div><img${ssrRenderAttr("src", weatherIcon.value)} alt="\u041F\u043E\u0433\u043E\u0434\u0430" class="weather-card__icon" data-v-65004a13></div><div class="weather-card__bottom" data-v-65004a13><p class="weather-card__info" data-v-65004a13>\u0412\u0440\u0435\u043C\u044F: ${ssrInterpolate(__props.time)}</p><p class="weather-card__info" data-v-65004a13>\u0413\u043E\u0440\u043E\u0434: ${ssrInterpolate(__props.city)}</p></div></div>`);
    };
  }
};
...
const WeatherCard = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-65004a13"]]);
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "details" }, _attrs))} data-v-763173cf><img${ssrRenderAttr("src", unref(ICONS).bigCloud)} alt="" class="details__cloud-bg" style="${ssrRenderStyle({ "width": "100%", "height": "100%" })}" data-v-763173cf><ul class="details__list" data-v-763173cf><li class="details__row" data-v-763173cf><img${ssrRenderAttr("src", unref(ICONS).temperature)} alt="" class="details__icon" data-v-763173cf><span class="details__label" data-v-763173cf>\u0422\u0435\u043C\u043F\u0435\u0440\u0430\u0442\u0443\u0440\u0430</span><span class="details__value" data-v-763173cf>${ssrInterpolate(__props.temp)}\xB0 - \u043E\u0449\u0443\u0449\u0430\u0435\u0442\u0441\u044F \u043A\u0430\u043A ${ssrInterpolate(__props.feelsLike)}\xB0</span></li><li class="details__row" data-v-763173cf><img${ssrRenderAttr("src", unref(ICONS).pressure)} alt="" class="details__icon" data-v-763173cf><span class="details__label" data-v-763173cf>\u0414\u0430\u0432\u043B\u0435\u043D\u0438\u0435</span><span class="details__value" data-v-763173cf>${ssrInterpolate(__props.pressure)} \u043C\u043C \u0440\u0442\u0443\u0442\u043D\u043E\u0433\u043E \u0441\u0442\u043E\u043B\u0431\u0430 - \u043D\u043E\u0440\u043C\u0430\u043B\u044C\u043D\u043E\u0435</span></li><li class="details__row" data-v-763173cf><img${ssrRenderAttr("src", unref(ICONS).rain)} alt="" class="details__icon" data-v-763173cf><span class="details__label" data-v-763173cf>\u041E\u0441\u0430\u0434\u043A\u0438</span><span class="details__value" data-v-763173cf>${ssrInterpolate(__props.precipitation)}</span></li><li class="details__row" data-v-763173cf><img${ssrRenderAttr("src", unref(ICONS).wind)} alt="" class="details__icon" data-v-763173cf><span class="details__label" data-v-763173cf>\u0412\u0435\u0442\u0435\u0440</span><span class="details__value" data-v-763173cf>${ssrInterpolate(__props.windSpeed)} \u043C/\u0441 ${ssrInterpolate(__props.windDir)} - ${ssrInterpolate(__props.windDesc)}</span></li></ul></div>`);
    };
  }
};
...
const WeatherDetails = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-763173cf"]]);
const _sfc_main$2 = {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "page" }, _attrs))} data-v-4b794cec><p class="page__label" data-v-4b794cec>Vue weather</p><div class="page__card" data-v-4b794cec>`);
      _push(ssrRenderComponent(AppHeader, {
        onToggleTheme: toggleTheme,
        onOpenModal: ($event) => modalOpen.value = true
      }, null, _parent));
      _push(`<div class="page__main" data-v-4b794cec>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4b794cec"]]);

export { index as default };
//# sourceMappingURL=index-CSA8hs-e.mjs.map
