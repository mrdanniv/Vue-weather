...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "weather-card" }, _attrs))} data-v-b6994778><div class="weather-card__top" data-v-b6994778><div data-v-b6994778><p class="weather-card__temp" data-v-b6994778>${ssrInterpolate(__props.temp)}\xB0</p><p class="weather-card__day" data-v-b6994778>${ssrInterpolate(__props.dayLabel)}</p></div><img${ssrRenderAttr("src", weatherIcon.value)} alt="\u041F\u043E\u0433\u043E\u0434\u0430" class="weather-card__icon" data-v-b6994778></div><div class="weather-card__bottom" data-v-b6994778><p class="weather-card__info" data-v-b6994778>\u0412\u0440\u0435\u043C\u044F: ${ssrInterpolate(__props.time)}</p><p class="weather-card__info" data-v-b6994778>\u0413\u043E\u0440\u043E\u0434: ${ssrInterpolate(__props.city)}</p></div></div>`);
    };
  }
};
...
//# sourceMappingURL=index-Cdjf93_M.mjs.map
